...
const AppleHello: React.FC<AppleHelloProps> = ({
    className = "",
    color = "white",
    onAnimationComplete
}) => {
    // Exact paths extracted from the Framer AppleHelloEffect
    const path1 = "M8.69214 166.553C36.2393 151.239 61.3409 131.548 89.8191 98.0295C109.203 75.1488 119.625 49.0228 120.122 31.0026C120.37 17.6036 113.836 7.43883 101.759 7.43883C88.3598 7.43883 79.9231 17.6036 74.7122 40.9363C69.005 66.5793 64.7866 96.0036 54.1166 190.356";
    ...
    // Standard properties
    const strokeWidth = 12; // Adjusted for better visibility at 600px
    const transition1 = { duration: 0.8, ease: "easeInOut" };
    const transition2 = {
        duration: 2.2,
        delay: 0.6,
        ease: "easeInOut",
    ...
    return (
        <div className={`relative w-full max-w-[800px] h-auto aspect-[638/200] flex items-center justify-center ${className}`}>
            <svg
                viewBox="0 0 638 220"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-full h-full drop-shadow-[0_0_30px_rgba(255,255,255,0.25)]"
            >
                {/* Glow Paths */}
                <motion.path
                    d={path1}
