        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[1000] flex items-center justify-center bg-[#0B0B0F]/95 backdrop-blur-2xl px-4 py-8 md:p-12"
                >
                    ...
                    >
                        ...
                        <div className="flex-1 relative bg-[#121212] overflow-hidden">
                            <iframe
                                src="/resume/current_resume.pdf#toolbar=0"
                                className="w-full h-full border-none"
                                title="Resume Viewer"
                            />
                            
                            {/* Cinematic Overlay - subtle gradient to match brand */}
